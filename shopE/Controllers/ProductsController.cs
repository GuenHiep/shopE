...
namespace shopE.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var shopEContext = _context.Product.Include(p => p.Category);
		...
		{
			var shopEContext = _context.Product.Include(p => p.Category).Where(p=>p.Name.Contains(keywords)&&p.CategoryId==catid);
			return View(await shopEContext.ToListAsync());
		}
